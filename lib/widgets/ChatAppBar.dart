...
import 'package:flutter_app1/config/Assets.dart';
import 'package:flutter_app1/config/Palette.dart';

class ChatAppBar extends StatelessWidget implements PreferredSizeWidget {
  final double height = 100;
  @override
  Widget build(BuildContext context) {
    var textHeading = TextStyle(color: Palette.secondaryColor, fontSize: 20); // Text style for the name
    var textStyle = TextStyle(color: Palette.secondaryColor); // Text style for everything else
